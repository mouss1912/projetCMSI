...
try {
	$query = "SELECT idLog, typelogement, prix, typeTransaction, localite, nbrePiece, description, photo FROM logement WHERE typelogement = '$typeLogement' AND nbrePiece = '$nbrePiece' AND localite LIKE '%$localite%';";
