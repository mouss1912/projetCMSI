...
<script type="text/javascript">
    ...
    function add_box(typeTransaction, typeLogement, description, localite , prix){
        var chain ="";
        url_img   = "images";


        // if (url_img == "") {
        //     url_img = "https://previews.123rf.com/images/cheryledavis/cheryledavis1102/cheryledavis110200006/8825584-un-assortiment-de-bonbons-color%C3%A9s-sur-fond-de-full-frame-avec-drag%C3%A9es-bonbons-et-autres-sucreries-gel%C3%A9e.jpg";
        // }
        // else if( url_img.indexOf("http") == -1 && url_img.indexOf("/") == -1){
        //     url_img = "./uploads/"+url_img;
        // }
        ...
        chain += '<h4 class="card-title">' + typeTransaction + '</h4>'
        chain += '<h4 class="card-title">' + typeLogement + '</h4>'
        ...
        chain += '<label for="show-menu" class="menu-button id_input glyphicon glyphicon-remove" data-id="'+id+'"></label>';
        chain += '</div>';


        // chain += '<div class="wrapper" style="background: url('+url_img+') 20% 1%/cover no-repeat;">';
