                ...
                <div class="col-lg-12">
                    <div class="slider-container">
                       <form action="listeLogement.php" method="post" id="formu">
                          ...
                          <select class="custom-select custom-select-lg mb-3 col-lg-3" name="typeLogement" id="typeLogement">
                          ...
                          <select class="custom-select custom-select-lg mb-3 col-lg-3" id="localite" name="localite">
                              <option selected>Localisation</option>
                              <?php
                              $query = "SELECT localite FROM logement;";
    ...
    <div class="container">
        <form action="listeLogement.php" method="post" id="formu" enctype="multipart/form-data" style="text-align: center;" >
          ...
          <!--   <div class="form-group">
                            ...
                            <div>
                                <input type="text" id="nomProprio" name="nomProprio" placeholder="nom du propretaire">
                            </div> 

                            <p>Prenom propriétaire</p>
                            <div>
                                <input type="text" id="prenomProprio" name="prenomProprio" placeholder="prenom du propretaire">
                            </div> 
